...
class ActorControllerTest {
	...
	void showAllTest() throws Exception {
		Actor test1 = new Actor(1, "testName");
		Actor test2 = new Actor(2, "testName2");

		Mockito.when(actorService.getAll()).thenReturn(Arrays.asList(test1, test2));
	...
	void showOneTest() throws Exception {
		...
		Mockito.when(actorService.getOne(1)).thenReturn(test);
